...
export const registerUserBody = z.object({
    ...
    password: z
        .string()
        .regex(passwordRegex, "Password must be at least 8 characters and include an uppercase letter, lowercase letter, number, and special character."),
});
...
export const userHeaders = z.object({
    authorization: z
        .string()
        .regex(/^Bearer\s.+$/, "Authorization header must be in the format: Bearer <token>"),
});
