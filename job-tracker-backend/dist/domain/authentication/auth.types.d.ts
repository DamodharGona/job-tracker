...
import type { loginUserBody, registerUserBody, registerUserResponse } from "./auth.schema.js";
...
export type RegisterUserRepositoryInput = Omit<RegisterUserServiceInput, "password"> & {
    passwordHash: string;
};
export type loginUserRepositoryInput = Omit<LoginUserServiceInput, "password">;
export type registerUserServiceResponse = z.infer<typeof registerUserResponse> & {
    token: string;
};
